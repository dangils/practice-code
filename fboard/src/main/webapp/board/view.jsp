...
%>	
	...
	<jsp:useBean id="reDAO" class="com.koreait.reply.ReplyDAO"/>
...
<%
		...
		List<ReplyDTO> list = reDAO.view_reply(String.valueOf(b_idx));
			//board.getIdx()로 가져온 idx값을 매개변수로 받는 view_reply(입력된 댓글 출력) 메서드의 리턴값을 
			//replyDTO에 set
			
			if(list!=null){ //replyDTO에서 reply의 list를 get		
				for(ReplyDTO arr : list){
%>
